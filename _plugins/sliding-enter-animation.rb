...
Jekyll::Hooks.register([:pages, :posts], :post_render) do |page|
    if page.path.end_with?(".html", ".md")
        ...
        noko.search("audio, blockquote, div.card, div.highlighter-rouge, div.news, div.repositories, div.row, div.social, div.tag-category-list, figure, h2, h3, p, video").each_with_index do |tag, index|
